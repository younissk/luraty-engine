...
The previous version of this engine lived *inside* the app. When the app was rewritten, the engine
...
randomness as a seed, and content as a request the *host* fulfils. That is what makes a session
