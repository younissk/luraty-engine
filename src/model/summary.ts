import type { Day, Direction, Variety } from './ids.js';

/**
 * A fixed-size snapshot of a learner, for the host to persist and diff.
 *
 * @module
 */

/**
 * What a {@link Summary} covers.
 *
...
export type Summary = {
  ...
  /**
   * How many units sit at each rung, `0` through {@link MAX_STRENGTH}.
   *
   ...
   *
   * The distinction matters on screen: this number going down is progress, whereas {@link known}
   * going down is bad news, and a host that renders them the same way will tell her the opposite of
   * the truth.
   */
  ...
  /** Units at `lapses >= STUCK_AFTER_LAPSES`. Not sticking; see {@link Session.stuck}. */
