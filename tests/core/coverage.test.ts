...
import { COVERAGE_BAND, type Band, type Coverage } from '../../src/model/index.js';
import { unitKey, variety, type Day, type Direction, type Variety } from '../../src/model/index.js';
